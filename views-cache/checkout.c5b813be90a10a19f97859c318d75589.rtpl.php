									...
									<div class="woocommerce-billing-fields">
										...
										<div id="order_review" style="position: relative;">
											...
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												...
												<label class="" for="method-paypal"><img style="height:100px;" src="/res/site/img/logo-paypal.png"></label>
											</p>
											<p id="billing_state_field" class="form-row form-row-first address-field validate-state" data-o_class="form-row form-row-first address-field validate-state">
												<input type="radio" id="method-pagseguro" name="payment-method" placeholder="País" value="1" style="float:left; margin: 30px;">
												<label class="" for="method-pagseguro"><img style="height:100px;" src="/res/site/img/logo-pagseguro.png"></label>
											</p>
											<div id="payment">
