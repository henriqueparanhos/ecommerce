      ...
      <tr>
        ...
        <td class="container">
          <div class="content footer-lead">
            <a href="#"><b>Entre em contato</b> caso tenha algum dúvida ou sugestão.
          </div>
        </td>
        <td></td>
      </tr>
        ...
        <td class="container">
          <div class="content">
            ...
            <span class="footer-group">
              <a href="#">Facebook</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="#">Instagram</a>&nbsp;&nbsp;|&nbsp;&nbsp;
              <a href="https://retratodaarte.com.br">Site</a>
            </span>
          </div>
        </td>
        <td></td>
