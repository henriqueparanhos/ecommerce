<?php if(!class_exists('Rain\Tpl')){exit;}?><div style="margin-top: 5%;" class="slider-area">
            <!-- Slider -->
    ...
    <div style="margin-top: 10%;" class="maincontent-area">
                            ...
                            <div class="single-product">
                                <div class="product-f-image">
                                    <img src="<?php echo htmlspecialchars( $value1["desphoto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" alt="">
                                        ...
                                        <a href="/cart/<?php echo htmlspecialchars( $value1["idproduct"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/addcart" ><i class="fa fa-shopping-bag"></i>Adicionar ao Carrinho</a>
                                </div>
