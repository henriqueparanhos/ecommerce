            ...
            <div class="row">
                <div class="col-md-3 col-sm-6">
                    <div class="footer-about-us">
                        <h2>Retrato da Arte</h2>
                        <p>Melhor loja de Arte do país!</p>
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="footer-newsletter">
                        <h2 class="footer-wid-title">Fique por dentro das novidades!</h2>
                        <p>Ao adicionar o seu email você concorda em receber Anúncios e Promoções da Loja Retrato da Arte</p>
    ...
    <div class="footer-bottom-area">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <div class="copyright">
                        <p>&copy; Copyright 2021 <a href="www.retratodar.com.br" target="_blank">Retrato da Arte</a></p>
                    </div>
                </div>
